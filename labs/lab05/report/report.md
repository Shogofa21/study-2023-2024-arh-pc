...
![Открытие файла](image/8.png){#fig:fig1 width=70% }
...
![Оттранслирование текста программы](image/9.png){#fig:fig1 width=70% }

![](image/10.png){#fig:fig1 width=70% }

![Выполнение компановки](image/11.png){#fig:fig1 width=70% }

![](image/12.png){#fig:fig1 width=70% }

![Запуск файла](image/13.png){#fig:fig1 width=70% }

![Ввод с клавиатуры](image/14.png){#fig:fig1 width=70% }
...
![Скачивание файла с ТУИС](image/15.png){#fig:fig1 width=70% }

3.2 Задание 10:

Копируем подключаемый файл in_out.asm в каталог lab05 (рис. [3.2])

![Копирование файла](image/16.png){#fig:fig1 width=70% }
...
![Создание копии файла](image/18.png){#fig:fig1 width=70% }

![](image/19.png){#fig:fig1 width=70% }
...
![Исправление текста](image/21.png){#fig:fig1 width=70% }

![Проверка работы](image/22.png){#fig:fig1 width=70% }
...
![Изменение файла](image/23.png){#fig:fig1 width=70% }

![Запуск файла](image/24.png){#fig:fig1 width=70% }
...
![](image/25.png){#fig:fig1 width=70% }

![Открытие копии файла](image/26.png){#fig:fig1 width=70% }

4.2 Задание 2:

Получим исполняемый файл и проверим его работу. На приглашение ввести строку введу свою фамилию (рис. [4.2]).

![Конвертирование и запуск программы](image/27.png){#fig:fig1 width=70% }
...
![](image/28.png){#fig:fig1 width=70% }

![Создании копии файла](image/29.png){#fig:fig1 width=70% }

4.4 Задание 4:

Создадим исполняемый файл и проверим его работу (рис. [4.4]).

![Проверяем работу](image/30.png){#fig:fig1 width=70% }

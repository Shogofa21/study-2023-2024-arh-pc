...
![](/labs/lab04/repotr/image/2.jpg){#fig:fig1 width=70% }
3- Создайте текстовый файл с именем hello.asm
![Создал текстовый файл с именем hello.asm](/labs/lab04/report/image/3.png){#fig:fig1 width=70% }
4-откройте этот файл с помощью любого текстового редактора, например, gedit
![Открыл этот файл с помощью gedit](/labs/lab04/report/image/4.1.png){#fig:fig1 width=70% }
...
фамилией и именем.
![](/labs/lab04/report/image/11.1.png){#fig:fig1 width=70% }
